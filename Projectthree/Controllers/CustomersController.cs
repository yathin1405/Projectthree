...
namespace Projectthree.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            else
            {
                ...
                var show1cust = (from me in db.Users
                                 ...
                                 select new { CustID = e.CustID, FirstName = e.FirstName, Surname = e.Surname, Email = me.Email, CellNum = e.CellNum, HomeNum = e.HomeNum, Address = e.Address }).ToList();
     ...
     /*   public ActionResult ShowEmail(string Em)
        ...
        public ActionResult Create([Bind(Include = "CustID,FirstName,Surname,Email,CellNum,HomeNum,Address")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustID,FirstName,Surname,Email,CellNum,HomeNum,Address")] Customer customer)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Customer customer = db.CustomersTB.Find(id);
            db.CustomersTB.Remove(customer);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
