...
namespace Projectthree.Controllers
{
    public class VehiclesController : Controller
    {
       ...
       //      return View(db.VehiclesTB.ToList());
        ...
        public ActionResult Create([Bind(Include = "PolicyID,CustID,PDriverName,PDLicenceNum,SDriverName,SDLicenceNum,Make,Model,year,RegNum,VinNum,party3,Compre,Engineplan,writeoff,Pricex")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PolicyID,CustID,PDriverName,PDLicenceNum,SDriverName,SDLicenceNum,Make,Model,year,RegNum,VinNum,party3,Compre,Engineplan,writeoff,Pricex")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
                vehicle.Pricex = vehicle.getPrice();
