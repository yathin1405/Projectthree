...
namespace Projectthree.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            else
            {
                ...
                var show1cust = (from p in db.Users
                                 ...
                                 select new { me.ReportNum, e.CustID, me.ClaimPolicyID, me.DateOI, me.Location, me.DriverName, me.DamageDescription, me.Amount }).ToList();
        ...
        public ActionResult Create([Bind(Include = "ReportNum,CustID,ClaimPolicyID,,DateOI,Location,DriverName,DamageDescription,Amount")] Claim claim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReportNum,CustID,ClaimPolicyID,,DateOI,Location,DriverName,DamageDescription,Amount")] Claim claim)
        {
            if (ModelState.IsValid)
            {
